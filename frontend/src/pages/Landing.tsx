        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 z-10">
            ...
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              RentFlow reports your on-time rent payments to credit bureaus,
              helping you build credit history automatically. Landlords get paid
              faster, Tenants get credit.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                asChild
              >
                <Link to="/signup">I'm a Landlord</Link>
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              We've built a platform that aligns incentives for everyone
              involved in the rental ecosystem.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-100 hover:shadow-lg transition-all group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Automatically report on-time rent payments to major credit
                bureaus to boost your score safely.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-emerald-100 hover:shadow-lg transition-all group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Bank-level encryption ensures your financial data is always
                protected and payments are verified.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-purple-100 hover:shadow-lg transition-all group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Direct integration with property management systems to ensure
                payment accuracy and history.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="rounded-3xl bg-primary p-12 text-white relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-blue-100 mb-8 max-w-md">
                  Build your credit score just by paying rent. Simple setup,
                  automatic reporting, and full transparency.
                </p>
                <Button variant="secondary" size="lg" asChild>
                  <Link to="/signup">Launch Tenant Portal</Link>
                </Button>
              </div>
            </div>
            ...
            <div className="rounded-3xl bg-slate-100 p-12 text-slate-900 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600 mb-8 max-w-md">
                  Streamline rent collection and attract high-quality tenants
                  who care about their credit.
                </p>
                <Button variant="default" size="lg" asChild>
                  <Link to="/signup">Launch Landlord Portal</Link>
                </Button>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <Button
              ...
              asChild
            >
               <Link to="/admin/login">View Admin Dashboard (Demo)</Link>
            </Button>
          </div>
        </div>
      </section>
